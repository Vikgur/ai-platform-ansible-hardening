...
- [Модель угроз Ansible Hardening в Sovereign AI](#модель-угроз-ansible-hardening-в-sovereign-ai)
- [Модели атакующих](#модели-атакующих)
- [Защищаемые активы](#защищаемые-активы)
- [AI-специфичные угрозы](#ai-специфичные-угрозы)
- [Supply Chain атаки](#supply-chain-атаки)
- [Lateral Movement](#lateral-movement)
  - [Node → Node](#node--node)
  - [Workload → Node](#workload--node)
  - [Workload → Workload](#workload--workload)
- [Assumptions и ограничения](#assumptions-и-ограничения)
- [Митигирующие слои](#митигирующие-слои)
- [Маппинг угроз на контроли](#маппинг-угроз-на-контроли)
- [Использование модели угроз](#использование-модели-угроз)
