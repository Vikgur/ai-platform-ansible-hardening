...
- [Архитектура Ansible Hardening в Sovereign AI](#архитектура-ansible-hardening-в-sovereign-ai)
- [Место Ansible Hardening в Sovereign AI](#место-ansible-hardening-в-sovereign-ai)
- [Цепочка управления и исполнения](#цепочка-управления-и-исполнения)
- [Границы доверия](#границы-доверия)
- [Control Plane и Data Plane](#control-plane-и-data-plane)
- [Enforcement и декларация](#enforcement-и-декларация)
- [Предположения и гарантии безопасности](#предположения-и-гарантии-безопасности)
- [Day-0 / Day-1 / Day-2 модель](#day-0--day-1--day-2-модель)
